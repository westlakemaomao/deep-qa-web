/**
* @author hzyuyongmao
* @version 创建时间：2016年9月8日 下午7:54:36
* 类说明
*/
package tools.nlp.keywords;

import java.util.List;

import com.hankcs.hanlp.HanLP;

public class GetArticleKeywords {
	...
	public static List<String> getKeywords(String document) {
		return HanLP.extractKeyword(document, 5);
	}
}
